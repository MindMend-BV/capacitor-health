...
| **`postSamples`** | <code><a href="#backgroundsyncapirequestoptions">BackgroundSyncApiRequestOptions</a></code>                                                                                                                                                                                                                                                                                                                                        | Backend endpoint used to upload background-collected samples. MindMend / AD-028 body: `{ data: { healthSubjectId, sourcePlatform?, deliveredViaBackgroundSync: true, samples: HealthSample[] } }`.                                                                                                                                                                  |
